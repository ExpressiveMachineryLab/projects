...
namespace TE.Examples
{
    ...
    /// </summary>
    public class EmitterController : MonoBehaviour, IOnTangibleAdded, IOnTangibleRemoved, IOnTangibleUpdated, IOnEnginePatternsChanged
    {
        //public float offset;
        ...
        {
            Debug.Log("set new emitter" + newEmitter);
